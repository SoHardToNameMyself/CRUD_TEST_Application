...
namespace CRUD_TEST_Application.Models
{
    public class CRUDModel
    {
        string strConString = @"Data Source = (LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\yicheng\Desktop\program\ConsoleApp1\CRUD_TEST_Application\App_Data\DB.mdf;Integrated Security = True";
        /// <summary>    
